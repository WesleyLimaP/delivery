...
public interface RestauranteFormaDePagamentoControllerDoc {
    ...
    ResponseEntity<List<com.delivery.project.app.api.model.dto.formaDePagamentoDto.response.FormaDePagamentoResponseDto>> findById(@PathVariable Long restauranteId);
    ...
    ResponseEntity<List<com.delivery.project.app.api.model.dto.formaDePagamentoDto.response.FormaDePagamentoResponseDto>> associar(
